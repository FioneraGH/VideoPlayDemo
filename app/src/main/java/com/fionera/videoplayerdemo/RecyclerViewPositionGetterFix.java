...
/**
 * Created by fionera on 16-5-30.
 */

public class RecyclerViewPositionGetterFix
        implements ItemsPositionGetter {

    private static final boolean SHOW_LOGS = Config.SHOW_LOGS;
    private static final String TAG = com.volokh.danylo.visibility_utils.scroll_utils
            .RecyclerViewItemPositionGetter.class
            .getSimpleName();

    private LinearLayoutManager mLayoutManager;
    private RecyclerView mRecyclerView;

    public RecyclerViewPositionGetterFix(LinearLayoutManager layoutManager,
    ...
    public View getChildAt(int position) {
        if (SHOW_LOGS) {
            Logger.v(TAG,
                     "getChildAt, mRecyclerView.getChildCount " + mRecyclerView.getChildCount());
            Logger.v(TAG,
                     "getChildAt, mLayoutManager.getChildCount " + mLayoutManager.getChildCount());
        }
        ...
        if (SHOW_LOGS) {
            ...
            Logger.v(TAG,
                     "mLayoutManager getChildAt, position " + position + ", view " + mLayoutManager
                             .getChildAt(position));
        }
